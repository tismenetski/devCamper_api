...
exports.getReviews = asyncHandler(async (req, res, next) => {
  if (req.params.bootcampId) {
    //if a bootcamp id attached , find the specific id and return the reviews related to the bootcamp
    ...
    // no bootcamp id parameter, return all the reviews with pagination ,limit and ect...
